...
**Discovered during:** WaTech Application Inventory product development
**Context:** The existing MGMT-01-01-S policy already defined the data model and controlled vocabularies. The EasyEA workflow had no step for recognizing and inheriting existing standards.
**Recommended change:** Add "Inherit Existing Data Standards" as an explicit input to the capability design step — especially for government products where policy often pre-defines the data model.
...
**Discovered during:** WaTech Application Inventory — Portfolio Intelligence capability
**Context:** A core government EA use case is identifying where multiple agencies use the same technology and could consolidate into a shared service. EasyEA has no artifact for this.
**Recommended change:** Add a **Central Services Candidate Register** as a standard output of the Data Insights step for government EA engagements.

---

### FI-04 — ARB Personas Gap in Early-Stage Ideation
**Discovered during:** WaTech Application Inventory ARB review
